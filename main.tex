...
\mbox{}
\input{Chapters/kurzdarstellung}
\newpage
\thispagestyle{empty} % empty
\mbox{}
\tableofcontents
...
\thispagestyle{empty} % empty
\mbox{}
% \input{Chapters/Slowcontrol}  % doesnt exist
% \input{Chapters/Developement} % doesnt exist
% \input{Chapters/Application} % doesnt exist
\input{Chapters/Conclusion}
\bibliography{../bibliography/masterthesis}  % relative path to .bib file. sys-dependent
\bibliographystyle{ieeetr}
\includepdf[page={1}]{Chapters/erklaerung}
\end{document}
