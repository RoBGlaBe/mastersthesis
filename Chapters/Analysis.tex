...
The detection principles of \gls{lxe} \glsp{tpc} are well know.
...
The previous investigation of \glspls{se} and the subsequent measurement of the amplification gain $ g_\mathrm{SE} $ further allow us to quantify the extraction efficiency in the dual-phase \gls{tpc} of \gls{xebra}.
