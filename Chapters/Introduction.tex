...
This effectively amplifies them to an average fixed amount of photons per electron extracted (S2 signal).
...
The mentioned parts are held in place by a support structure out of steel.
...
While the experiment is running, Xenon is constantly taken out of the \gls{tpc} and lead through the getter before it is lead back inside for continuous cleaning.
We call this process \emph{cycling}.
Every time the \gls{gxe} is lead back, it has to be cooled to become liquid.
