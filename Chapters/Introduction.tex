...
\paragraph{Strax,} the \emph{stream analysis for xenon TPCs} encloses the essential software tools to process the data stored on disk by the \gls{daq}.  % TODO add github cite
...
\begin{figure}
\centering
\includegraphics[width=\figw\textwidth]{Figures/th.jpeg}  % {Figures/data_structure.png}
\caption[Data Hierarchie in Straxbra]{
