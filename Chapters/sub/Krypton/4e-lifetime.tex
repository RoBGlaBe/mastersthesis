...
We can improve (larger $ \tau $) the electron lifetime by reducing the amount of impurities inside the \gls{lxe} by cycling through the getter as described in % TODO Referenz auf getter/gassystem...: \ref{sec:}
