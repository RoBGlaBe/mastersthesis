...
\FloatBarrier
\subsection{\isotope[83][36]{Kr} Singal Production}
\label{ssec:source}
\FloatBarrier
...
\paragraph{A Krypton run} is a run for which we fill the \gls{tpc} with the metastable Krypton Isotope \isotope[83m2][36]{Kr} via the Rubidium source in the gas system as described above.
