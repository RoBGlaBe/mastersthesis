...
The Krypton source we use (sec.~\ref{ssec:}) predominantly emits electrons and photons, which both interact with the Xenon's shell electrons, what we call \gls{er}. %  TODO ref
